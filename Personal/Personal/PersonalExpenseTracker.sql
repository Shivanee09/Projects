...
CREATE TABLE `users` (
  ...
  `email` varchar(50) NOT NULL,
  `password` varchar(50) NOT NULL,
  `profile_path` varchar(255) DEFAULT 'default_profile.png' -- Add profile_path column
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `users` (`user_id`, `firstname`, `lastname`, `email`, `password`, `profile_path`) VALUES
(9, 'Anjalita', 'Fernandes', 'anjalita@sjec.in', 'b7161ae9080c2604adb157463312ed47', 'default_profile.png'),
(12, 'Ebey', 'Joe Regi', 'ejr@sjec.in', '25d55ad283aa400af464c76d713c07ad', 'default_profile.png');
